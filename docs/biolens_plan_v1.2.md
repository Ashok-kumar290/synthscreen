...
├── .gitignore
├── docs/
│   ├── interactive_docs.html      # one-point access to all md docs
│   ├── biolens_plan_v1.md         # initial plan (archived)
│   ├── biolens_plan_v1.1.md       # revised plan (archived)
│   └── biolens_plan_v1.2.md       # finalized plan (this file)
├── scripts/
│   └── generate_docs.py           # regenerates interactive_docs.html
...
- `docs/interactive_docs.html` is regenerated by `scripts/generate_docs.py`
